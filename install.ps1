...
foreach ($command in @(
    'Start-PPWorkSession','Show-PPCorporateWelcome','Get-PPStatus','Export-PPSession','Open-PPLatest','Open-PPExportFolder',
    'Stop-PPSession','Show-PPPanel','Set-PPSessionVariable','Get-PPSessionVariable','Remove-PPSessionVariable','Set-PPLocation',
