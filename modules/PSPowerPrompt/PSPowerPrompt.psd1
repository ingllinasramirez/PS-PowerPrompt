@{
    ...
    Description = 'Professional PowerShell workspace with session capture, secure exports, productivity shortcuts and local or multi-provider AI assistance.'
    ...
    AliasesToExport = @(
        'pp-start','pp-status','pp-new','pp-restart','pp-help','pp-export','pp-export-safe','pp-export-jsonl','pp-open','pp-stop','pp-panel',
        'pp-set','pp-vars','pp-unset','pp-go','pp-ask','pp-explain','pp-fix','pp-ai-status','pp-ai-config','pp-update','pp-uninstall','pp-doctor'
    )
    CmdletsToExport = @()
    VariablesToExport = @()
    PrivateData = @{ PSData = @{ Tags = @('PowerShell','Transcript','AI','Ollama','LocalAI','OpenAI','Gemini','DeepSeek','HuggingFace','Copilot','Productivity','Security'); ProjectUri = 'https://github.com/ingllinasramirez/PS-PowerPrompt' } }
}