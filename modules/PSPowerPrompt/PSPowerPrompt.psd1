@{
    ...
    FunctionsToExport = @(
        ...
        'Set-PPSessionVariable','Get-PPSessionVariable','Remove-PPSessionVariable','Set-PPLocation','Protect-PPText',
        'Export-PPSafeSession','Export-PPJsonlSession','Invoke-PPAIRequest','Invoke-PPExplainCommand','Invoke-PPFixLastError',
        'Get-PPAIStatus','Set-PPAIProvider','Invoke-PPUpdate','Invoke-PPUninstall','Test-PPInstallation'
    )
    AliasesToExport = @(
        'pp-start','pp-status','pp-new','pp-restart','pp-help','pp-export','pp-export-safe','pp-export-jsonl','pp-open','pp-stop',
        'pp-panel','pp-set','pp-vars','pp-unset','pp-go','pp-ask','pp-explain','pp-fix','pp-ai-status','pp-ai-config',
