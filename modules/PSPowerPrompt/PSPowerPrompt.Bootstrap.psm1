...
# Carga los componentes funcionales en el mismo ambito del modulo raiz.
...
# La bienvenida se define directamente en el modulo raiz para garantizar
# que PowerShell pueda exportarla y encontrarla despues de Import-Module.
